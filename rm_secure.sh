# Initial script edited by Chistophe Blaess and available on his website https://www.blaess.fr/christophe/
# This script improve rm command by moving deleted files in a hidden directory so user can recover deleted file.
# Put this script in /bin and modify .bashrc y adding this line : . ~/bin/rm_secure.sh
# Also there is an option to list the "trash" (-l) and one to clear the "trash" (-e)
#
# Exercice : Look at the script and modify it :
#	- change the restore directory, its name, its place etc.
#	- improve the script to provide more confidentialitty by removing all permissions exept for their owner
